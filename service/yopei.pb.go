...
type CheckBalanceMessage struct {
	...
	YopeiId int32 `protobuf:"varint,1,opt,name=yopeiId,proto3" json:"yopeiId,omitempty"`
}

func (x *CheckBalanceMessage) Reset() {
	*x = CheckBalanceMessage{}
	if protoimpl.UnsafeEnabled {
		mi := &file_model_yopei_proto_msgTypes[0]
...
func (*CheckBalanceMessage) Descriptor() ([]byte, []int) {
	return file_model_yopei_proto_rawDescGZIP(), []int{0}
}

func (x *CheckBalanceMessage) GetYopeiId() int32 {
	if x != nil {
		return x.YopeiId
	}
	return 0
...
func (x *PaymentMessage) Reset() {
	*x = PaymentMessage{}
	if protoimpl.UnsafeEnabled {
		mi := &file_model_yopei_proto_msgTypes[1]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*PaymentMessage) Descriptor() ([]byte, []int) {
	return file_model_yopei_proto_rawDescGZIP(), []int{1}
}

func (x *PaymentMessage) GetYopeiId() int32 {
	if x != nil {
		return x.YopeiId
	}
	return 0
...
func (x *Error) Reset() {
	*x = Error{}
	if protoimpl.UnsafeEnabled {
		mi := &file_model_yopei_proto_msgTypes[2]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*Error) Descriptor() ([]byte, []int) {
	return file_model_yopei_proto_rawDescGZIP(), []int{2}
}
...
func (x *ResultMessage) Reset() {
	*x = ResultMessage{}
	if protoimpl.UnsafeEnabled {
		mi := &file_model_yopei_proto_msgTypes[3]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*ResultMessage) Descriptor() ([]byte, []int) {
	return file_model_yopei_proto_rawDescGZIP(), []int{3}
}
...
var File_model_yopei_proto protoreflect.FileDescriptor

var file_model_yopei_proto_rawDesc = []byte{
	0x0a, 0x11, 0x6d, 0x6f, 0x64, 0x65, 0x6c, 0x2f, 0x79, 0x6f, 0x70, 0x65, 0x69, 0x2e, 0x70, 0x72,
	0x6f, 0x74, 0x6f, 0x22, 0x2f, 0x0a, 0x13, 0x43, 0x68, 0x65, 0x63, 0x6b, 0x42, 0x61, 0x6c, 0x61,
	0x6e, 0x63, 0x65, 0x4d, 0x65, 0x73, 0x73, 0x61, 0x67, 0x65, 0x12, 0x18, 0x0a, 0x07, 0x79, 0x6f,
	0x70, 0x65, 0x69, 0x49, 0x64, 0x18, 0x01, 0x20, 0x01, 0x28, 0x05, 0x52, 0x07, 0x79, 0x6f, 0x70,
	0x65, 0x69, 0x49, 0x64, 0x22, 0x42, 0x0a, 0x0e, 0x50, 0x61, 0x79, 0x6d, 0x65, 0x6e, 0x74, 0x4d,
	0x65, 0x73, 0x73, 0x61, 0x67, 0x65, 0x12, 0x18, 0x0a, 0x07, 0x79, 0x6f, 0x70, 0x65, 0x69, 0x49,
	0x64, 0x18, 0x01, 0x20, 0x01, 0x28, 0x05, 0x52, 0x07, 0x79, 0x6f, 0x70, 0x65, 0x69, 0x49, 0x64,
	...
	0x05, 0x65, 0x72, 0x72, 0x6f, 0x72, 0x32, 0x76, 0x0a, 0x0c, 0x59, 0x6f, 0x70, 0x65, 0x69, 0x50,
...
var (
	file_model_yopei_proto_rawDescOnce sync.Once
	file_model_yopei_proto_rawDescData = file_model_yopei_proto_rawDesc
)

func file_model_yopei_proto_rawDescGZIP() []byte {
	file_model_yopei_proto_rawDescOnce.Do(func() {
		file_model_yopei_proto_rawDescData = protoimpl.X.CompressGZIP(file_model_yopei_proto_rawDescData)
	})
	return file_model_yopei_proto_rawDescData
}

var file_model_yopei_proto_msgTypes = make([]protoimpl.MessageInfo, 4)
var file_model_yopei_proto_goTypes = []interface{}{
	(*CheckBalanceMessage)(nil), // 0: CheckBalanceMessage
	(*PaymentMessage)(nil),      // 1: PaymentMessage
	(*Error)(nil),               // 2: Error
	(*ResultMessage)(nil),       // 3: ResultMessage
}
var file_model_yopei_proto_depIdxs = []int32{
	2, // 0: ResultMessage.error:type_name -> Error
	0, // 1: YopeiPayment.CheckBalance:input_type -> CheckBalanceMessage
	1, // 2: YopeiPayment.DoPayment:input_type -> PaymentMessage
	3, // 3: YopeiPayment.CheckBalance:output_type -> ResultMessage
	3, // 4: YopeiPayment.DoPayment:output_type -> ResultMessage
...
func init() { file_model_yopei_proto_init() }
func file_model_yopei_proto_init() {
	if File_model_yopei_proto != nil {
		return
	}
	if !protoimpl.UnsafeEnabled {
		file_model_yopei_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
		...
		file_model_yopei_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
		...
		file_model_yopei_proto_msgTypes[2].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*Error); i {
			case 0:
				return &v.state
			case 1:
		...
		file_model_yopei_proto_msgTypes[3].Exporter = func(v interface{}, i int) interface{} {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_model_yopei_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   4,
			NumExtensions: 0,
			NumServices:   1,
		},
		GoTypes:           file_model_yopei_proto_goTypes,
		DependencyIndexes: file_model_yopei_proto_depIdxs,
		MessageInfos:      file_model_yopei_proto_msgTypes,
	}.Build()
	File_model_yopei_proto = out.File
	file_model_yopei_proto_rawDesc = nil
	file_model_yopei_proto_goTypes = nil
	file_model_yopei_proto_depIdxs = nil
}
